...
.product-details > *:nth-child(6) { animation-delay: 0.6s; }

.spec-item:nth-child(1) { animation-delay: 0.3s; }
.spec-item:nth-child(2) { animation-delay: 0.4s; }
...
>>>>>>> 4d18588fce04aef23792227ce91fa87d3cfe4515
    ...
    document.querySelectorAll('.spec-item, .delivery-option, .product-carousel').forEach((el) => {
        observer.observe(el);
    });
