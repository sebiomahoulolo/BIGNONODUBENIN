                ...
                <div class="product-carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img id="mainProductImage" src="{{ asset('storage/' . $product->images[0]) }}"
                                class="d-block w-100 main-image rounded" alt="{{ $product->nombre_places }}">
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($product->images as $key => $image)
                        <div class="col-3">
                            <div class="thumbnail-item {{ $key === 0 ? 'active' : '' }}">
                                <img src="{{ asset('storage/' . $image) }}" class="img-fluid rounded thumbnail-image"
                                    alt="{{ $product->nombre_places }}" onclick="swapImages(this)">
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="product-details">
                    <h1 class="product-title mb-3">
                        <span
                            class="badge "style="color:rgb(227, 236, 247)  ;  background-color: #366ba2">{{ $product->category->name }}</span>
                    </h1>

                    <div class="price-container mb-4">
                        @if ($product->sale_price)
                            <span
                                class="original-price text-muted text-decoration-line-through me-2 fs-6 fs-sm-6 fs-md-6 fs-lg-6 fs-xl-6 fs-xxl-6">
                                {{ number_format($product->price, 0, ',', ' ') }} FCFA
                            </span>
                            <span class="sale-price fw-bold text-success me fs-2 fs-sm-6 fs-md-3 fs-lg-3 fs-xl-3 fs-xxl-3">
                                {{ number_format($product->sale_price, 0, ',', ' ') }} FCFA
                            </span>
                            <span class="discount-badge badge bg-danger fs-6 fs-sm-6 fs-md-6 fs-lg-6 fs-xl-6 fs-xxl-6">
                                {{ $product->discount_percentage }}%
                            </span>
                        @else
                            <span
                                class="current-price fw-bold text-primary">{{ number_format($product->price, 0, ',', ' ') }}
                                FCFA</span>
                        @endif
                    </div>
                    ...
                    <div class="specifications-container mb-4">
                        ...
                        <ul class="list-unstyled">
                            <li style="color: #ff2c2c"><i class="bi bi-people me-2" style="color: #ff2c2c"></i>Nombre de
                                places : {{ $product->nombre_places }}</li>
                            <li style="color:#ff2c2c"><i class="bi bi-box me-2 "style="color: #ff2c2c"></i>Matière :
                                {{ $product->matiere }}</li>
                            <li style="color:#ff2c2c"><i class="bi bi-check-circle me-2"style="color: #ff2c2c"></i>Stock :
                                {{ $product->stock }} unités</li>
                        </ul>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                <button type="button" class="btn  btn-lg w-100 add-to-cart-btn add-to-cart"
                                    data-id="{{ $product->id }}" data-name="{{ $product->category->name }}"
                    ...
                    <div class="card h-100 border-0 shadow-md product-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-2">
                                ...
                                @else
                                    <img src="{{ asset('images/no-image.jpg') }}" class="card-img-top rounded-top"
                                        alt="{{ $product->name }}">
                                @endif
                            ...
                            <div class="card-body d-flex flex-column">
                                <span class="badge  mb-2"
                                    style="color:white  ;  background-color: #366ba2">{{ $product->category->name }}</span>

                                <div class="mb-2">
                                    @if ($product->sale_price)
                                        <span
                                            class="text-success fw-bold">{{ number_format($product->sale_price, 0, ',', ' ') }}
                                            FCFA</span>
                                    @else
                                        <span
